...
export function buildCSS(T) { return `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  body{
    ...
    background-image:
      radial-gradient(at 8% 6%, rgba(79, 224, 168, 0.14) 0px, transparent 38%),
      radial-gradient(at 92% 94%, rgba(0, 82, 45, 0.12) 0px, transparent 44%),
      radial-gradient(at 78% 8%, rgba(197, 232, 214, 0.28) 0px, transparent 38%),
      radial-gradient(at 18% 88%, rgba(79, 224, 168, 0.08) 0px, transparent 36%),
