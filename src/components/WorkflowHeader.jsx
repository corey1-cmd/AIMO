    ...
    <header style={{ marginBottom: 30, position: 'relative' }}>
      ...
      <p style={{
        ...
        특정 시간에 반드시 시작해야 하는 일정이라면 <span aria-hidden style={{ display: 'inline-block', verticalAlign: 'middle', marginRight: 4 }}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: T.color.textMuted }}>
    ...
    >
      <defs>
        <linearGradient id="wfWave2" x1="0%" y1="50%" x2="100%" y2="50%">
          ...
          <stop offset="50%" stopColor={T.color.electricMint} stopOpacity="0.42" />
          <stop offset="100%" stopColor={T.color.electricMint} stopOpacity="0.85" />
        </linearGradient>
      </defs>
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="378" cy="9" r="2.4" fill={T.color.electricMint} />
      <circle cx="378" cy="9" r="6" fill={T.color.electricMint} opacity="0.18" />
    </svg>
  );
}
