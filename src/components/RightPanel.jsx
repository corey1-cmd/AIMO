...
export function RightPanel({ mode, activePlan, onAnalyze, onResumeFocus, onCloseFocus, onShowGuide, onBack }) {
  const [tasks, setTasks] = useState([{ id: uid(), title: '', estimatedMin: '', category: '', fixedTime: false }]);
  ...
  const addTask = () => {
    ...
    setTasks([...tasks, { id: uid(), title: '', estimatedMin: '', category: '', fixedTime: false }]);
  };
  const removeTask = (id) => {
