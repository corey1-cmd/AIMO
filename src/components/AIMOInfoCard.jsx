    ...
    <section style={{
      ...
      <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 8, position: 'relative' }}>
        ...
        <div style={{
          ...
          1,366 <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.62)', fontWeight: T2.font.weightRegular }}>단계</span>
          <span style={{ color: 'rgba(255,255,255,0.30)', margin: '0 8px', fontSize: 14 }}>·</span>
          회귀 <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.62)', fontWeight: T2.font.weightRegular }}>0</span>
        </div>
        ...
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.color = T2.color.accent; }}
  ...
  return (
    <div style={{ position: 'relative', width: 56, height: 56, flexShrink: 0 }}>
      <svg width="56" height="56" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <circle cx="24" cy="24" r="2.2" fill={T2.color.accent} opacity="0.85" />
      </svg>
    </div>
  );
}
