 ...
 * 🏆 가장 빠르게 완료한 Top 3
 * Props: records, onSelect */

import { T, formatMin } from '../constants';

export function Top3({ records, onSelect }) {
...
const rankStyle = () => ({
  ...
  background: T.color.mint, color: T.color.primary,
  display: 'flex', alignItems: 'center', justifyContent: 'center',
  fontSize: 13, fontWeight: T.font_.weight.bold, flexShrink: 0,
});
