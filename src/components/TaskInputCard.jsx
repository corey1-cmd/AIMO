  ...
  return (
    ...
    >
      ...
      <div aria-hidden style={{
        ...
        background: focused ? `linear-gradient(180deg, ${T.color.primary}, ${T.color.electricMint})` : 'transparent',
  ...
  return (
    <label style={{
      ...
      <span style={{
        ...
        alignItems: 'center',
        justifyContent: 'center',
        boxShadow: checked && !soft ? `0 0 0 3px ${T.color.mintSoft}` : 'none',
      ...
      <span style={{
        fontSize: 13,
        color: checked ? T.color.textPrimary : T.color.textSecondary,
        fontWeight: checked ? T.font_.weight.medium : T.font_.weight.regular,
      }}>{label}</span>
      <input
        type="checkbox"
        checked={checked}
