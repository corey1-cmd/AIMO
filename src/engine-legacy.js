...
/* ══════════════════════════════════════════════════════════
   키워드 사전
   word → { type: 행동유형, complexity: 1-10, energy: 1-5, domain: UI카테고리 }
   ══════════════════════════════════════════════════════════ */
const KEYWORD_DB = {
  "보고서":{type:"COGNITIVE",complexity:7,energy:4,domain:"create"},
  "리포트":{type:"COGNITIVE",complexity:7,energy:4,domain:"create"},
  "논문":{type:"COGNITIVE",complexity:9,energy:5,domain:"create"},
  "발표":{type:"COGNITIVE",complexity:7,energy:5,domain:"talk"},
  "프레젠테이션":{type:"COGNITIVE",complexity:7,energy:5,domain:"talk"},
  "회의":{type:"COGNITIVE",complexity:5,energy:3,domain:"talk"},
  "미팅":{type:"COGNITIVE",complexity:5,energy:3,domain:"talk"},
  "면접":{type:"COGNITIVE",complexity:8,energy:5,domain:"talk"},
  "전화":{type:"MECHANICAL",complexity:3,energy:2,domain:"talk"},
  "통화":{type:"MECHANICAL",complexity:3,energy:2,domain:"talk"},
  "이메일":{type:"MECHANICAL",complexity:3,energy:2,domain:"digital"},
  "메일":{type:"MECHANICAL",complexity:3,energy:2,domain:"digital"},
  "코딩":{type:"COGNITIVE",complexity:7,energy:4,domain:"digital"},
  "개발":{type:"COGNITIVE",complexity:7,energy:4,domain:"digital"},
  "프로그래밍":{type:"COGNITIVE",complexity:7,energy:4,domain:"digital"},
  "디버깅":{type:"COGNITIVE",complexity:8,energy:5,domain:"digital"},
  "테스트":{type:"EVALUATIVE",complexity:5,energy:3,domain:"digital"},
  "배포":{type:"MECHANICAL",complexity:6,energy:3,domain:"digital"},
  "디자인":{type:"COGNITIVE",complexity:6,energy:4,domain:"create"},
  "글쓰기":{type:"COGNITIVE",complexity:6,energy:4,domain:"create"},
  "작성":{type:"COGNITIVE",complexity:5,energy:3,domain:"create"},
  "블로그":{type:"COGNITIVE",complexity:5,energy:3,domain:"create"},
  "영상":{type:"COGNITIVE",complexity:7,energy:4,domain:"create"},
  "편집":{type:"COGNITIVE",complexity:6,energy:4,domain:"create"},
  "기획":{type:"COGNITIVE",complexity:7,energy:4,domain:"create"},
  "브레인스토밍":{type:"COGNITIVE",complexity:5,energy:3,domain:"create"},
  "이동":{type:"MECHANICAL",complexity:2,energy:2,domain:"move"},
  "출근":{type:"MECHANICAL",complexity:2,energy:2,domain:"move"},
  "퇴근":{type:"MECHANICAL",complexity:2,energy:1,domain:"move"},
  "장보기":{type:"MECHANICAL",complexity:3,energy:2,domain:"move"},
  "쇼핑":{type:"MECHANICAL",complexity:3,energy:2,domain:"move"},
  "운동":{type:"MECHANICAL",complexity:3,energy:4,domain:"physical"},
  "헬스":{type:"MECHANICAL",complexity:3,energy:4,domain:"physical"},
  "청소":{type:"MECHANICAL",complexity:3,energy:3,domain:"physical"},
  "요리":{type:"MECHANICAL",complexity:4,energy:3,domain:"physical"},
  "정리":{type:"MECHANICAL",complexity:4,energy:2,domain:"organize"},
  "분류":{type:"MECHANICAL",complexity:3,energy:2,domain:"organize"},
  "자료":{type:"MECHANICAL",complexity:4,energy:3,domain:"organize"},
  "리서치":{type:"EVALUATIVE",complexity:5,energy:3,domain:"organize"},
  "조사":{type:"EVALUATIVE",complexity:5,energy:3,domain:"organize"},
  "분석":{type:"EVALUATIVE",complexity:7,energy:4,domain:"organize"},
  "검색":{type:"MECHANICAL",complexity:2,energy:1,domain:"digital"},
  "공부":{type:"COGNITIVE",complexity:6,energy:4,domain:"organize"},
  "학습":{type:"COGNITIVE",complexity:6,energy:4,domain:"organize"},
  "복습":{type:"MECHANICAL",complexity:4,energy:3,domain:"organize"},
  "시험":{type:"COGNITIVE",complexity:8,energy:5,domain:"organize"},
  "예약":{type:"MECHANICAL",complexity:2,energy:1,domain:"digital"},
  "계획":{type:"EVALUATIVE",complexity:5,energy:3,domain:"organize"},
  "피드백":{type:"EVALUATIVE",complexity:4,energy:3,domain:"talk"},
  "리뷰":{type:"EVALUATIVE",complexity:5,energy:3,domain:"organize"},
  "점검":{type:"EVALUATIVE",complexity:3,energy:2,domain:"wait"},
  "확인":{type:"EVALUATIVE",complexity:2,energy:1,domain:"wait"},
  "제출":{type:"MECHANICAL",complexity:2,energy:1,domain:"digital"},
  "설치":{type:"MECHANICAL",complexity:4,energy:2,domain:"digital"},
  "설정":{type:"MECHANICAL",complexity:3,energy:2,domain:"digital"},
};
...
function classifyTask(title, estimatedMin) {
  let best = null;
  for (const [kw, info] of Object.entries(KEYWORD_DB)) {
    if (title.includes(kw) && (!best || info.complexity > best.complexity)) {
      best = { keyword: kw, ...info };
    }
  }
  if (!best) best = { keyword: null, type: "COGNITIVE", complexity: 4, energy: 3, domain: "other" };
...
function decomposeTask(task, learningData) {
  ...
  const baseMin = task.estimatedMin || 30;
